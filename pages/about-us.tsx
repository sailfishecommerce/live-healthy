          ...
          <div className="col-md-6 px-3 px-md-5 py-5">
            <div className="mx-auto py-lg-5" style={{ maxWidth: "35rem" }}>
              ...
              <p className="fs-sm pb-3 text-muted">
                ...
                Duis erat lectus, ultrices euismod sagittis at, pharetra eu
                nisl. Phasellus id ante at velit tincidunt hendrerit. Aenean
                dolor dolor tristique nec. Tristique nulla aliquet enim tortor
                at auctor urna nunc. Sit amet aliquam id diam maecenas ultricies
                mi eget.
              </p>
              <Link href="/shop" passHref>
                <a className="btn btn-primary btn-shadow">View products</a>
              </Link>
            </div>
          </div>
        </section>
          ...
          <div className="col-md-6 px-3 px-md-5 py-5">
            <div className="mx-auto py-lg-5" style={{ maxWidth: "35rem" }}>
              ...
              <p className="fs-sm pb-3 text-muted">
                ...
                fermentum leo. Integer ut eros lacus. Proin ut accumsan leo.
                Morbi vitae est eget dolor consequat aliquam eget quis dolor.
                Mauris rutrum fermentum erat, at euismod. Duis erat lectus,
                ultrices euismod sagittis at dolor tristique nec. Tristique
          ...
          <div className="col-md-6 px-3 px-md-5 py-5 order-md-1">
            <div className="mx-auto py-lg-5" style={{ maxWidth: "35rem" }}>
              ...
              <Link href="/contact-us" passHref>
                <a className="btn btn-warning btn-shadow">See outlet stores</a>
              </Link>
            </div>
          </div>
        </section>
